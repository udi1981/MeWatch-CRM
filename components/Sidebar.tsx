...
interface SidebarProps {
  activeTab?: 'dashboard' | 'leads' | 'tasks';
    ...
    <aside className="w-64 bg-slate-900 text-white flex flex-col hidden md:flex">
      <div className="p-6">
        ...
        <nav className="space-y-1">
          ...
          >
            <UsersIcon />
            <span className="font-medium text-right flex-1">לידים</span>
          </button>
          ...
          >
            <CalendarIcon />
            <span className="font-medium text-right flex-1">משימות ותזכורות</span>
          </button>
        </nav>
      </div>
